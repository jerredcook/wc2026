...
- **Results browser** — a collapsible *Results* section lists **every completed match grouped by round** (Group A–L, then the knockouts), each with its goals & cards timeline by minute and tappable into the full match card — the results-organized companion to the venue-organized schedule grid, with a running matches-played / goals tally.
