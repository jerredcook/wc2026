...
- **Pick'em** — predict every match (Home / Draw / Away, or the winner in knockouts), name your champion, and watch your calls score themselves as results land: correct picks turn green, wrong ones strike through red with the actual outcome dash-outlined, above a running record and accuracy %. There's a one-tap shareable summary and a reset. It's all saved on your device (in your saved preferences) — no account, nothing sent anywhere.
